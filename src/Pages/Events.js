...
function ExamplePage() {
  return (
    <>
		<div>
		  <h1>Meetup</h1>
		  We regularly meet up on Wednesdays from 6:30pm to 8:30pm. After the meetup a number of us go to Sully's House Bar across the street for food and drinks.<br/>
