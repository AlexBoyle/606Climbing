	...
	return (
		...
		>
			...
			<CardActions>
				<div
					onClick={openVenmo}
					class="paypal-button paypal-button-number-1 paypal-button-layout-vertical paypal-button-shape-rect paypal-button-branding-branded paypal-button-number-multiple paypal-button-env-production paypal-should-focus paypal-button-label-venmo paypal-button-color-blue paypal-button-logo-color-white"
				>
					<div
					...
					>
						...
						<img
							class="paypal-button-logo paypal-button-logo-venmo paypal-button-logo-blue"
