...
function BasicCard() {
  ...
  return (
	...
	<CardMedia
          component="img"
          height="140"
          image="https://avatars.githubusercontent.com/u/11150836?v=4"
          alt="Picture of Alex"
        />
      <CardContent>
      ...
      <CardActions>
		<div class="paypal-button paypal-button-number-1 paypal-button-layout-vertical paypal-button-shape-rect paypal-button-branding-branded paypal-button-number-multiple paypal-button-env-production paypal-should-focus paypal-button-label-venmo paypal-button-color-blue paypal-button-logo-color-white">
