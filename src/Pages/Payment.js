	...
	return (
		...
		>
			...
			<CardActions>
				<div
					onClick={openVenmo}
					className="paypal-button paypal-button-number-1 paypal-button-layout-vertical paypal-button-shape-rect paypal-button-branding-branded paypal-button-number-multiple paypal-button-env-production paypal-should-focus paypal-button-label-venmo paypal-button-color-blue paypal-button-logo-color-white"
				>
					<div
					...
					>
						...
						<img
							className="paypal-button-logo paypal-button-logo-venmo paypal-button-logo-blue"
	...
	return (
		<>
			<div style={{ fontSize: "25px" }}>
				After our regular climbing we usually go to Sully's House. As we go as
				...
				>
					{data?.length > 0
						? data.map(function (obj, index) {
								return BasicCard(obj, setSelectedUser);
						  })
						: null}
				</div>
			</div>
